...
struct PressureLogWidget: View {
  ...
  var body: some View {
    VStack(spacing: 0) {
      ...
      PartPressureTimeRow(part: "뒤통수", time: pressureLog.occiput)
      PartPressureTimeRow(part: "견갑골", time: pressureLog.scapula)
      PartPressureTimeRow(part: "우측 팔꿈치", time: pressureLog.elbow)
      PartPressureTimeRow(part: "좌측 팔꿈치", time: pressureLog.elbow)
      PartPressureTimeRow(part: "엉덩이", time: pressureLog.hip)
      PartPressureTimeRow(part: "우측 발꿈치", time: pressureLog.heel)
      PartPressureTimeRow(part: "좌측 발꿈치", time: pressureLog.heel)
    }
