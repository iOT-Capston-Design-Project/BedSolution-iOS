...
struct PostureLogWidget: View {
  ...
  var body: some View {
    VStack(spacing: 0) {
      ...
      PartPressureTimeRow(part: "뒤통수", time: pressureLog.occiput, threshold: vm.occiputThreshold)
      PartPressureTimeRow(part: "견갑골", time: pressureLog.scapula, threshold: vm.scapulaThreshold)
      PartPressureTimeRow(part: "우측 팔꿈치", time: pressureLog.elbow, threshold: vm.rightElbowThreshold)
      PartPressureTimeRow(part: "좌측 팔꿈치", time: pressureLog.elbow, threshold: vm.leftElbowThreshold)
      PartPressureTimeRow(part: "엉덩이", time: pressureLog.hip, threshold: vm.hipThreshold)
      PartPressureTimeRow(part: "우측 발꿈치", time: pressureLog.heel, threshold: vm.rightHeeelThreshold)
      PartPressureTimeRow(part: "좌측 발꿈치", time: pressureLog.heel, threshold: vm.leftHeelThreshold)
    }
